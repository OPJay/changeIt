...
import com.fullpower.changeit.adapters.FavoritePagerAdapterOffline;
...
public class FavoritePagerActivityOffline extends AppCompatActivity {
    ...
    private FavoritePagerAdapterOffline mFavoritePagerAdapter;
    private String TAG = "WallpaperPagerActivity";
    private int tab;
    private int position;
    public static List<PhotoObject> list;
    public static List<File> filesFromStorage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        filesFromStorage = FavoriteRecyclerViewAdapterOffline.getFilesFromPhotos();
        addToList(list);
    ...
    public static Intent newIntent(Context packageContext, int
        ...
        Intent intent = new Intent(packageContext,
                FavoritePagerActivityOffline.class);
    ...
    private void UpdateUI() {
        ...
        if (mFavoritePagerAdapter == null) {
            mFavoritePagerAdapter = new FavoritePagerAdapterOffline(fragmentManager, this, tab);
